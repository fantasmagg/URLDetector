...
model = load('C:/curos/ia/deepLearning/deepLearning/machine/URLDectetor/NOSE/url/test/model_filenameG.joblib')
...
urls = ['https://paste.ee/d/0xLQR,1','https://wisdomml.in/malicious-url-detection-using-machine-learning-in-python/']
for url in urls:
